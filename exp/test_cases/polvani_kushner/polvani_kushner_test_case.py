...
if __name__ == '__main__':
    ...
    #exp.run(1, num_cores=NCORES, restart_file='/disco/share/rm811/isca_data/'+exp_name+'/restarts/res0106.tar.gz', use_restart=True)
    for i in range(2, 505): #~42y worth (inc. 2y of spin-up)
